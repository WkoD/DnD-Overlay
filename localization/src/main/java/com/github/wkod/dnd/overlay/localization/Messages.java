...
public enum Messages implements Localizable {
    ...
    CONFIGURATION_INVALID_BOOLEAN,

    CLIENT_CONFIGURATION_SAVE,
    CLIENT_DATA_INVALID_IMAGE,
    CLIENT_DATA_TRANSFER,
    CLIENT_DATA_TRANSFER_ERROR,
    CLIENT_DATA_TRANSFER_INVALID_TYPE,
    CLIENT_SCREEN_RESET,
    CLIENT_SCREEN_TOGGLE,
